...
protected:
    ...
    inline std::string typename_holder() const noexcept 
    {
    ...
    public:
        ...
        inline tkey const &get_key() const noexcept
        {
            if (is_state_initialized())
                return *_key;
            throw std::logic_error("BST::Iterator_data::get_key: Iterator data is not initialized\n");
        }
...
#pragma region binary_search_tree<tkey, tvalue> methods implementation
...
void binary_search_tree<tkey, tvalue>::set_insertion_strategy(
        typename binary_search_tree<tkey, tvalue>::insertion_of_existent_key_attempt_strategy insertion_strategy) noexcept
{
    this->trace_with_guard(typename_holder() + "::set_insertion_strategy(insertion_of_existent_key_attempt_strategy) : called.")
            ->debug_with_guard(typename_holder() + "::set_insertion_strategy(insertion_of_existent_key_attempt_strategy) : called.")
            ->debug_with_guard(typename_holder() + "::set_insertion_strategy(insertion_of_existent_key_attempt_strategy) : insertion strategy set to "
...
void binary_search_tree<tkey, tvalue>::set_removal_strategy(
        typename binary_search_tree<tkey, tvalue>::disposal_of_nonexistent_key_attempt_strategy disposal_strategy) noexcept
{
    this->trace_with_guard(typename_holder() + "::set_disposal_strategy(disposal_of_nonexistent_key_attempt_strategy) : called.")
            ->debug_with_guard(typename_holder() + "::set_disposal_strategy(disposal_of_nonexistent_key_attempt_strategy) : called.")
            ->debug_with_guard(typename_holder() + "::set_disposal_strategy(disposal_of_nonexistent_key_attempt_strategy) : disposal strategy set to "
    ...
    this->trace_with_guard(typename_holder() + "::set_disposal_strategy(disposal_of_nonexistent_key_attempt_strategy) : successfuly handled.")
            ->debug_with_guard(typename_holder() + "::set_disposal_strategy(disposal_of_nonexistent_key_attempt_strategy) : successfuly handled.");
}
...
void binary_search_tree<tkey, tvalue>::small_left_rotation(
        ...
        bool validate) const
{
    this->trace_with_guard(typename_holder() + "::small_left_rotation() : called.")
            ->debug_with_guard(typename_holder() + "::small_left_rotation() : called.")
            ->debug_with_guard(typename_holder() + "::small_left_rotation() : rotating node with key \"" +
                               std::to_string(subtree_root->key) + "\"");

    if (validate && (subtree_root == nullptr || subtree_root->right_subtree == nullptr))
    {
        throw std::logic_error("Can't perform small left rotation");
    }
    ...
    this->trace_with_guard(typename_holder() + "::small_left_rotation() : successfuly handled.")
            ->debug_with_guard(typename_holder() + "::small_left_rotation() : successfuly handled.");
...
void binary_search_tree<tkey, tvalue>::small_right_rotation(
        ...
        bool validate) const
{
    this->trace_with_guard(typename_holder() + "::small_right_rotation() : called.")
            ->debug_with_guard(typename_holder() + "::small_right_rotation() : called.")
            ->debug_with_guard(typename_holder() + "::small_right_rotation() : rotating node with key \"" +
                               std::to_string(subtree_root->key) + "\"");

    if (validate && (subtree_root == nullptr || subtree_root->left_subtree == nullptr))
    {
        throw std::logic_error("Can't perform small right rotation");
    }
    ...
    this->trace_with_guard(typename_holder() + "::small_right_rotation() : successfuly handled.")
            ->debug_with_guard(typename_holder() + "::small_right_rotation() : successfuly handled.");
}
...
void binary_search_tree<tkey, tvalue>::big_left_rotation(
        ...
        bool validate) const
{
    this->trace_with_guard(typename_holder() + "::big_left_rotation() : called.")
            ->debug_with_guard(typename_holder() + "::big_left_rotation() : called.");

    if (validate && (subtree_root == nullptr ||
                     subtree_root->right_subtree == nullptr || subtree_root->right_subtree->left_subtree == nullptr))
    {
        throw std::logic_error("Can't perform big left rotation");
    }

    small_right_rotation(subtree_root->right_subtree, false);
    small_left_rotation(subtree_root, false);

    this->trace_with_guard(typename_holder() + "::big_left_rotation() : successfuly handled.")
            ->debug_with_guard(typename_holder() + "::big_left_rotation() : successfuly handled.");
}
...
void binary_search_tree<tkey, tvalue>::big_right_rotation(
        ...
        bool validate) const
{
    this->trace_with_guard(typename_holder() + "::big_right_rotation() : called.")
            ->debug_with_guard(typename_holder() + "::big_right_rotation() : called.");

    if (validate && (subtree_root == nullptr ||
                     subtree_root->left_subtree == nullptr || subtree_root->left_subtree->right_subtree == nullptr))
    {
        throw std::logic_error("Can't perform big right rotation");
    }

    small_left_rotation(subtree_root->left_subtree, false);
    small_right_rotation(subtree_root, false);

    this->trace_with_guard(typename_holder() + "::big_right_rotation() : successfuly handled.")
            ->debug_with_guard(typename_holder() + "::big_right_rotation() : successfuly handled.");
}
...
void binary_search_tree<tkey, tvalue>::double_left_rotation(
        ...
        bool validate) const
{
    this->trace_with_guard(typename_holder() + "::double_left_rotation() : called.")
            ->debug_with_guard(typename_holder() + "::double_left_rotation() : called.");

    if (validate && (subtree_root == nullptr ||
                     subtree_root->right_subtree == nullptr || subtree_root->right_subtree->right_subtree == nullptr))
    {
        throw std::logic_error("Can't perform double right rotation");
    }
    ...
    this->trace_with_guard(typename_holder() + "::double_left_rotation() : successfuly handled.")
            ->debug_with_guard(typename_holder() + "::double_left_rotation() : successfuly handled.");
}
...
void binary_search_tree<tkey, tvalue>::double_right_rotation(
        ...
        bool validate) const
{
    this->trace_with_guard(typename_holder() + "::double_right_rotation() : called.")
            ->debug_with_guard(typename_holder() + "::double_right_rotation() : called.");

    if (validate && (subtree_root == nullptr ||
                     subtree_root->left_subtree == nullptr || subtree_root->left_subtree->left_subtree == nullptr))
    {
        throw std::logic_error("Can't perform double left rotation");
    }
    ...
    this->trace_with_guard(typename_holder() + "::double_right_rotation() : successfuly handled.")
            ->debug_with_guard(typename_holder() + "::double_right_rotation() : successfuly handled.");
}
